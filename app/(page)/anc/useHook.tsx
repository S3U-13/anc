    ...
    const filteredItems = useMemo(() => {
        ...
        if (filterValue) {
            filtered = filtered.filter((item) =>
                String(item.hn_wife).toLowerCase().includes(filterValue.toLowerCase()) ||
                String(item.wife?.firstname || "").toLowerCase().includes(filterValue.toLowerCase()) ||
                String(item.husband?.firstname || "").toLowerCase().includes(filterValue.toLowerCase())
            );
        }
