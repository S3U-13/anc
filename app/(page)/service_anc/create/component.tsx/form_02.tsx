    ...
    return (
        <div className='grid grid-cols-4 gap-[10px] overflow-y-scroll max-h-[calc(90vh-300px)]'>
            ...
            <RadioGroup
                ...
                value={field.ma_id}
                onValueChange={(val) => handleChange({ target: { name: "ma_id", value: val } })}
            >
                {data
            ...
            <RadioGroup
                ...
                label="HIGH RISK"
                value={field.hr_id}
                onValueChange={(val) => handleChange({ target: { name: "hr_id", value: val } })}
            >
                {data
            ...
            <div className='col-span-4 px-[30px] grid grid-cols-4 gap-[10px]'>
                <Input className='col-span-2' size='sm' label="GCT 1" type='text'></Input>
                <Input className='col-span-2' size='sm' label="GCT 2" type='text'></Input>
                <Input className='col-span-2' size='sm' label="OGTT 1" type='text'></Input>
                <Input className='col-span-2' size='sm' label="OGTT 2" type='text'></Input>
                <Input className='col-span-2' size='sm' label="HbsAg" type='text'></Input>
                <Input className='col-span-2' size='sm' label="VDRL" type='text'></Input>
                <Input className='col-span-2' size='sm' label="Anti HIV" type='text'></Input>
                <Input className='col-span-2' size='sm' label="Hb Typing" type='text'></Input>
            </div>
            <div className='col-span-4 px-[30px] grid grid-cols-3 gap-[10px]'>
                <Input className='col-span-1 ' size='sm' label="Bl.gr" type='text'></Input>
                <Input className='col-span-1 ' size='sm' label="Rh" type='text'></Input>
                <Input className='col-span-1 ' size='sm' label="Hct" type='text'></Input>
            </div>
            <div className='col-span-4 grid px-[30px] grid-cols-4 gap-[10px] '>
                <Input className='col-span-2' size='sm' label="OF" type='text'></Input>
                <Input className='col-span-2' size='sm' label="DCIP" type='text'></Input>
            ...
            <RadioGroup
                ...
                label="PCR"
                value={field.pcr_id}
                onValueChange={(val) => handleChange({ target: { name: "pcr_id", value: val } })}
            >
                {data
            ...
            <RadioGroup
                ...
                onValueChange={(val) => handleChange({ target: { name: "cordo_id", value: val } })}
            >
                {data
            ...
            <Input className='col-span-4 px-[20px]' size='sm' label="อื่น" type='text'></Input>
            <RadioGroup
                className='col-span-4 px-[20px]'
                // label="เเนะนำการเจาะน้ำคร่ำตรวจโครโมโซม"
                value={field.abortion_id}
                onValueChange={(val) => handleChange({ target: { name: "abortion_id", value: val } })}
